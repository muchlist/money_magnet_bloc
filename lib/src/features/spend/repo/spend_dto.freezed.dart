...
mixin _$SpendResponseDTO {
  ...
  /// Serializes this SpendResponseDTO to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SpendResponseDTO
...
mixin _$SpendDTO {
  ...
  /// Serializes this SpendDTO to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SpendDTO
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
mixin _$SpendReqDTO {
  ...
  /// Serializes this SpendReqDTO to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
