...
mixin _$PocketResponseDTO {
  ...
  /// Serializes this PocketResponseDTO to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PocketResponseDTO
...
mixin _$PocketUserDTO {
  ...
  /// Serializes this PocketUserDTO to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PocketUserDTO
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
